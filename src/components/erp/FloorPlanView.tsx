...
const typeBorders: Record<string, string> = {
  standard: 'border-blue-300',
  deluxe: 'border-purple-300',
  executive: 'border-amber-300',
  suite: 'border-emerald-300',
  presidential: 'border-rose-300',
};
      ...
      <Card>
        <CardContent className="p-3">
          <div className="flex flex-wrap gap-4 items-center text-xs">
            <span className="font-medium text-muted-foreground">Room Types:</span>
                    ...
                    <Tooltip key={room.id}>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`
                            relative p-1.5 rounded-md border-2 transition-all duration-300
